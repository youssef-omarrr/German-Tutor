...
class GermanTutor:
    ...
    def correct(self, sentence: str) -> None:
        ...
        system_msg = (
            ...
            "1. Rewriting the sentence correctly. If the original is already correct, repeat it and confirm it was correct.\n"
            "2. Explaining each correction in clear bullet points, focusing on grammar rules and avoiding jargon.\n"
            "3. Suggesting at least two alternative wordings or style improvements to make the sentence sound more natural.\n"
            "4. Keeping all explanations concise and in English."
        )
